...
import ono.leo.jvcontroller.core.MainControllerImpl.Bind;
...
public interface MainController {
    ...
    public abstract Bind getBind(String viewProperty, String beanProperty);
    ...
    public abstract boolean hasSetter(String property);
